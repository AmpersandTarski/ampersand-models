...
$commandstr = array(
     1 => './adl579-2100 -p'.COMPILATIONS_PATH.' --theme='.USERROLE.' --dbName=atlas --css=RAP.css --import="'.FULLFILE.'" --fileformat=ADL1 --namespace='.USER.' rap.adl', //load
     ...
     6 => './adl579-2100 -p'.COMPILATIONS_PATH.basename(FULLFILE,'.adl').'/proto/ --dbName=adl --namespace='.USER.' -x --theme=student "'.FULLFILE.'"', //proto
     7 => './amp579 -o'.COMPILATIONS_PATH.basename(FULLFILE,'.adl').'/diag/ -f Latex --diagnosis "'.FULLFILE.'"', //diagnosis pdf
     8 => './adl579-2100 -p'.COMPILATIONS_PATH.basename(FULLFILE,'.adl').'/proto/ --dbName=adl --namespace='.USER.' "'.FULLFILE.'"', //proto
