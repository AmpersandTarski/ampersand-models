...
// Prototype v2.2.0.1918:1923M, build time: 29-Mar-12 10:52.44 (lib: Ampersand v2.2.0.547:548M, build time: 27-Mar-12 16:02.13)


$versionInfo = 'Prototype v2.2.0.1918:1923M, build time: 29-Mar-12 10:52.44 (lib: Ampersand v2.2.0.547:548M, build time: 27-Mar-12 16:02.13)';
...
$relationTableInfo =
  array
    ...
    , 'compilererror' => array ('srcConcept' => 'File', 'tgtConcept' => 'ErrorMessage', 'table' => 'compilererror', 'srcCol' => 'File', 'tgtCol' => 'ErrorMessage')
  ...
  array
    ...
    , 'compilererror' =>
        array
          ...
          , 'ErrorMessage' => array ( 'concept' => 'ErrorMessage', 'unique' => false, 'null' => false)
          )
    , 'imageurl' =>
        array
  ...
  array
    ( 'uniek path/filename' =>
        array ( 'name' => 'uniek path/filename'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(filename;filename~)\",\"-(filepath;filepath~)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"filename;filename~\" ] */
                              SELECT DISTINCT cfst.`File` AS src, csnd.`File` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`File`=cp.`File` AND csnd.`File`=cp.`File1`)
                          ) UNION (/* case: ECpl e
                                 ECpl [ \"filepath;filepath~\" ] */
                              SELECT DISTINCT cfst.`File` AS src, csnd.`File` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`File`=cp.`File` AND csnd.`File`=cp.`File1`)
                          ) UNION (SELECT DISTINCT `File` AS src, `File` AS tgt
                              FROM `File`
    ...
    , 'key gen' =>
        array ( 'name' => 'key gen'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(gengen;gengen~)\",\"-(genspc;genspc~)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"gengen;gengen~\" ] */
                              SELECT DISTINCT cfst.`Gen` AS src, csnd.`Gen` AS tgt
                              FROM `Gen` AS cfst,
                                   `Gen` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Gen`=cp.`Gen` AND csnd.`Gen`=cp.`Gen1`)
                          ) UNION (/* case: ECpl e
                                 ECpl [ \"genspc;genspc~\" ] */
                              SELECT DISTINCT cfst.`Gen` AS src, csnd.`Gen` AS tgt
                              FROM `Gen` AS cfst,
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Gen`=cp.`Gen` AND csnd.`Gen`=cp.`Gen1`)
                          ) UNION (SELECT DISTINCT `Gen` AS src, `Gen` AS tgt
                              FROM `Gen`
    ...
    , 'key pair' =>
        array ( 'name' => 'key pair'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(left;left~)\",\"-(right;right~)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"left;left~\" ] */
                              SELECT DISTINCT cfst.`Pair` AS src, csnd.`Pair` AS tgt
                              FROM `Pair` AS cfst,
                                   `Pair` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Pair`=cp.`Pair` AND csnd.`Pair`=cp.`Pair1`)
                          ) UNION (/* case: ECpl e
                                 ECpl [ \"right;right~\" ] */
                              SELECT DISTINCT cfst.`Pair` AS src, csnd.`Pair` AS tgt
                              FROM `Pair` AS cfst,
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Pair`=cp.`Pair` AND csnd.`Pair`=cp.`Pair1`)
                          ) UNION (SELECT DISTINCT `Pair` AS src, `Pair` AS tgt
                              FROM `Pair`
                              WHERE `Pair` IS NOT NULL AND `Pair` IS NOT NULL
    ...
    , 'key decl' =>
        array ( 'name' => 'key decl'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(decnm;decnm~)\",\"-(decsgn;src;(decsgn;src)~)\",\"-(decsgn;trg;(decsgn;trg)~)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"decnm;decnm~\" ] */
                              SELECT DISTINCT cfst.`Declaration` AS src, csnd.`Declaration` AS tgt
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Declaration`=cp.`Declaration` AND csnd.`Declaration`=cp.`Declaration1`)
                          ) UNION (/* case: ECpl e
                                 ECpl [ \"decsgn;src;(decsgn;src)~\" ] */
                              SELECT DISTINCT cfst.`Declaration` AS src, csnd.`Declaration` AS tgt
                              FROM `Declaration` AS cfst,
                                   `Declaration` AS csnd
                              WHERE NOT EXISTS
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Declaration`=cp.`Declaration` AND csnd.`Declaration`=cp.`Declaration1`)
                          ) UNION (SELECT DISTINCT `Declaration` AS src, `Declaration` AS tgt
                              FROM `Declaration`
    ...
    , 'property enum' =>
        array ( 'name' => 'property enum'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I[Property]\",\"\'->\'\",\"\'UNI\'\",\"\'TOT\'\",\"\'INJ\'\",\"\'SUR\'\",\"\'RFX\'\",\"\'IRF\'\",\"\'SYM\'\",\"\'ASY\'\",\"\'TRN\'\",\"\'PROP\'\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I[Property]\" ] */
                              SELECT DISTINCT cfst.`Property` AS src, csnd.`Property` AS tgt
                              FROM `Property` AS cfst,
                                   `Property` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                     ( /* case: ETyp x _
                                ...
                                WHERE cfst.`Property`=cp.`Property` AND csnd.`Property`=cp.`Property1`)
                          ) UNION (SELECT \'->\' AS src, \'->\' AS tgt
                          ) UNION (SELECT \'UNI\' AS src, \'UNI\' AS tgt
                          ) UNION (SELECT \'TOT\' AS src, \'TOT\' AS tgt
                          ) UNION (SELECT \'INJ\' AS src, \'INJ\' AS tgt
                          ) UNION (SELECT \'SUR\' AS src, \'SUR\' AS tgt
                          ) UNION (SELECT \'RFX\' AS src, \'RFX\' AS tgt
                          ) UNION (SELECT \'IRF\' AS src, \'IRF\' AS tgt
                          ) UNION (SELECT \'SYM\' AS src, \'SYM\' AS tgt
                          ) UNION (SELECT \'ASY\' AS src, \'ASY\' AS tgt
                          ) UNION (SELECT \'TRN\' AS src, \'TRN\' AS tgt
                          ) UNION (SELECT \'PROP\' AS src, \'PROP\' AS tgt
    ...
    , 'typed domain' =>
        array ( 'name' => 'typed domain'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(decpopu;pairvalue;left;cptos~)\",\"decsgn;src\",\"decsgn;src;(genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"decpopu;pairvalue;left;cptos~\" ] */
                              SELECT DISTINCT cfst.`Declaration` AS src, csnd.`cptnm` AS tgt
                              FROM `Declaration` AS cfst,
                                   `Conid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Declaration`=cp.`Declaration` AND csnd.`cptnm`=cp.`cptos`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"decsgn\",\"src\"] */
                              ...
                              SELECT DISTINCT ECps0.`Declaration` AS src, ECps2.`genspc` AS tgt
                              FROM `Declaration` AS ECps0,
                                   `Sign` AS ECps1,
        ...
        array ( 'name' => 'typed codomain'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE NOT EXISTS (SELECT * FROM 
                                      ...
                                      WHERE isect0.`Declaration`=cp.`Declaration` AND isect0.`cptos`=cp.`genspc`) AND isect0.`Declaration` IS NOT NULL AND isect0.`cptos` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(decpopu;pairvalue;right;cptos~)\",\"decsgn;trg\",\"decsgn;trg;(genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"decpopu;pairvalue;right;cptos~\" ] */
                              SELECT DISTINCT cfst.`Declaration` AS src, csnd.`cptnm` AS tgt
                              FROM `Declaration` AS cfst,
                                   `Conid` AS csnd
                              WHERE NOT EXISTS
                              ...
                              SELECT DISTINCT ECps0.`Declaration` AS src, ECps1.`trg` AS tgt
                              FROM `Declaration` AS ECps0,
                                   `Sign` AS ECps1
                              WHERE ECps0.`decsgn`=ECps1.`Sign`
                          ) UNION (/* case: (ECps es), with two or more elements in es.
    ...
    , 'rel name is decl name' =>
        array ( 'name' => 'rel name is decl name'
              ...
              , 'contentsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"-relnm \\\\/ reldcl;decnm\",\"-(reldcl;decnm) \\\\/ relnm\"] */
                          SELECT DISTINCT isect0.`Relation` AS src, isect0.`relnm` AS tgt
                          FROM 
                               ( /* case: EUni es
                                 ...
                                 (/* case: ECpl e
                                        ECpl [ \"relnm\" ] */
                                     SELECT DISTINCT cfst.`Relation`, csnd.`Varid` AS `relnm`
                                     FROM `Relation` AS cfst,
                                          `Varid` AS csnd
                                     WHERE NOT EXISTS
                                      (SELECT * FROM `Relation` AS cp
                                 ...
                                 (/* case: ECpl e
                                     ...
                                     WHERE NOT EXISTS
                                      (SELECT * FROM 
                                       ...
                                       WHERE cfst.`Relation`=cp.`Relation` AND csnd.`Varid`=cp.`decnm`)
                                 ) UNION (SELECT DISTINCT `Relation`, `relnm` AS `decnm`
                                     FROM `Relation`
                                     WHERE `Relation` IS NOT NULL AND `relnm` IS NOT NULL
    ...
    , 'conceptwijzigingen2' =>
        array ( 'name' => 'conceptwijzigingen2'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"cptos\" ] */
                              SELECT DISTINCT cfst.`cptnm` AS src, csnd.`AtomID` AS tgt
                              FROM `Conid` AS cfst,
                                   `AtomID` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `AtomID` AS cp
                                WHERE cfst.`cptnm`=cp.`cptos` AND csnd.`AtomID`=cp.`AtomID`)
                          ) UNION (SELECT DISTINCT `Concept` AS src, `AtomID` AS tgt
                              FROM `inios`
    ...
    , 'parseoftypefout' =>
        array ( 'name' => 'parseoftypefout'
              ...
              , 'violationsSQL' => 'SELECT DISTINCT `File` AS src, `ErrorMessage` AS tgt
                          FROM `compilererror`
                          WHERE `File` IS NOT NULL AND `ErrorMessage` IS NOT NULL'
              , 'contentsSQL' => '/* case: ECpl e
                             ECpl [ \"compilererror\" ] */
                          SELECT DISTINCT cfst.`File` AS src, csnd.`ErrorMessage` AS tgt
                          FROM `File` AS cfst,
                               `ErrorMessage` AS csnd
                          WHERE NOT EXISTS
                           (SELECT * FROM `compilererror` AS cp
                            WHERE cfst.`File`=cp.`File` AND csnd.`ErrorMessage`=cp.`ErrorMessage`)'
              , 'pairView' =>
                  array
                    ()
              )
    , 'specgenatoom' =>
        array ( 'name' => 'specgenatoom'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(cptos;atomvalue)\",\"-((genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~;cptos;atomvalue)\"] */
                          (/* case: ECpl e
                                 ECpl [ \"cptos;atomvalue\" ] */
                              SELECT DISTINCT cfst.`cptnm` AS src, csnd.`Atom` AS tgt
                              FROM `Conid` AS cfst,
                                   `Atom` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`cptos` AND csnd.`Atom`=cp.`atomvalue`)
                          ) UNION (/* case: ECpl e
                                 ECpl [ \"(genspc~;gengen \\/ genspc~;gengen;genspc~;gengen \\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~;cptos;atomvalue\" ] */
                              SELECT DISTINCT cfst.`cptnm` AS src, csnd.`Atom` AS tgt
                              FROM `Conid` AS cfst,
                                   `Atom` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`gengen` AND csnd.`Atom`=cp.`atomvalue`)
    ...
    , 'overtredingen' =>
        array ( 'name' => 'overtredingen'
              ...
              , 'contentsSQL' => '/* case: ECpl e
                             ECpl [ \"rrviols\" ] */
                          SELECT DISTINCT cfst.`rrnm` AS src, csnd.`Violation` AS tgt
                          FROM `ADLid` AS cfst,
                               `PairID` AS csnd
                          WHERE NOT EXISTS
                           (SELECT * FROM `rrviols` AS cp
                            WHERE cfst.`rrnm`=cp.`Rule` AND csnd.`Violation`=cp.`Violation`)'
              , 'pairView' =>
                  array
                    ()
              )
    , 'uni filename' =>
        array ( 'name' => 'uni filename'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(filename~;filename)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"filename~;filename\" ] */
                              SELECT DISTINCT cfst.`FileName` AS src, csnd.`FileName` AS tgt
                              FROM `FileName` AS cfst,
                                   `FileName` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                     ( /* case: (ECps es), with two or more elements in es.
                                ...
                                WHERE cfst.`FileName`=cp.`filename` AND csnd.`FileName`=cp.`filename1`)
                          ) UNION (SELECT DISTINCT `FileName` AS src, `FileName` AS tgt
                              FROM `FileName`
                              WHERE `FileName` IS NOT NULL AND `FileName` IS NOT NULL
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `File` AS cp
                                WHERE cfst.`File`=cp.`File` AND csnd.`File`=cp.`File`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"filename\",\"filename~\"] */
                              
                              SELECT DISTINCT ECps0.`File` AS src, ECps1.`File` AS tgt
                              FROM `File` AS ECps0,
    ...
    , 'uni filepath' =>
        array ( 'name' => 'uni filepath'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(filepath~;filepath)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"filepath~;filepath\" ] */
                              SELECT DISTINCT cfst.`FilePath` AS src, csnd.`FilePath` AS tgt
                              FROM `FilePath` AS cfst,
                                   `FilePath` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                     ( /* case: (ECps es), with two or more elements in es.
                                ...
                                WHERE cfst.`FilePath`=cp.`filepath` AND csnd.`FilePath`=cp.`filepath1`)
                          ) UNION (SELECT DISTINCT `FilePath` AS src, `FilePath` AS tgt
                              FROM `FilePath`
                              WHERE `FilePath` IS NOT NULL AND `FilePath` IS NOT NULL
    ...
    , 'uni sourcefile' =>
        array ( 'name' => 'uni sourcefile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(sourcefile~;sourcefile)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"sourcefile~;sourcefile\" ] */
                              SELECT DISTINCT cfst.`AdlFile` AS src, csnd.`AdlFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`AdlFile`=cp.`sourcefile` AND csnd.`AdlFile`=cp.`sourcefile1`)
                          ) UNION (SELECT DISTINCT `AdlFile` AS src, `AdlFile` AS tgt
                              FROM `File`
    ...
    , 'tot sourcefile' =>
        array ( 'name' => 'tot sourcefile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"sourcefile;sourcefile~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`ctxnm` AS src, csnd.`ctxnm` AS tgt
                              FROM `Conid` AS cfst,
                                   `Conid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `Conid` AS cp
                                WHERE cfst.`ctxnm`=cp.`ctxnm` AND csnd.`ctxnm`=cp.`ctxnm`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"sourcefile\",\"sourcefile~\"] */
                              
                              SELECT DISTINCT ECps0.`ctxnm` AS src, ECps1.`ctxnm` AS tgt
                              FROM `Conid` AS ECps0,
    ...
    , 'uni applyto' =>
        array ( 'name' => 'uni applyto'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(applyto~;applyto)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"applyto~;applyto\" ] */
                              SELECT DISTINCT cfst.`AdlFile` AS src, csnd.`AdlFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`AdlFile`=cp.`applyto` AND csnd.`AdlFile`=cp.`applyto1`)
                          ) UNION (SELECT DISTINCT `AdlFile` AS src, `AdlFile` AS tgt
                              FROM `File`
                              WHERE `AdlFile` IS NOT NULL AND `AdlFile` IS NOT NULL
    ...
    , 'tot applyto' =>
        array ( 'name' => 'tot applyto'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"applyto;applyto~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`G` AS src, csnd.`G` AS tgt
                              FROM `G` AS cfst,
                                   `G` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `G` AS cp
                                WHERE cfst.`G`=cp.`G` AND csnd.`G`=cp.`G`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"applyto\",\"applyto~\"] */
                              
                              SELECT DISTINCT ECps0.`G` AS src, ECps1.`G` AS tgt
                              FROM `G` AS ECps0,
    ...
    , 'uni functionname' =>
        array ( 'name' => 'uni functionname'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(functionname~;functionname)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"functionname~;functionname\" ] */
                              SELECT DISTINCT cfst.`String` AS src, csnd.`String` AS tgt
                              FROM `String` AS cfst,
                                   `String` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`String`=cp.`functionname` AND csnd.`String`=cp.`functionname1`)
                          ) UNION (SELECT DISTINCT `String` AS src, `String` AS tgt
                              FROM `String`
                              WHERE `String` IS NOT NULL AND `String` IS NOT NULL
        ...
        array ( 'name' => 'tot functionname'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE NOT EXISTS (SELECT * FROM 
                                      ...
                                      WHERE isect0.`G`=cp.`G` AND isect0.`G`=cp.`G1`) AND isect0.`G` IS NOT NULL AND isect0.`G` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"functionname;functionname~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`G` AS src, csnd.`G` AS tgt
                              FROM `G` AS cfst,
    ...
    , 'uni operation' =>
        array ( 'name' => 'uni operation'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(operation~;operation)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"operation~;operation\" ] */
                              SELECT DISTINCT cfst.`Int` AS src, csnd.`Int` AS tgt
                              FROM `Int` AS cfst,
                                   `Int` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Int`=cp.`operation` AND csnd.`Int`=cp.`operation1`)
                          ) UNION (SELECT DISTINCT `Int` AS src, `Int` AS tgt
                              FROM `Int`
                              WHERE `Int` IS NOT NULL AND `Int` IS NOT NULL
    ...
    , 'uni newfile' =>
        array ( 'name' => 'uni newfile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(newfile~;newfile)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"newfile~;newfile\" ] */
                              SELECT DISTINCT cfst.`NewAdlFile` AS src, csnd.`NewAdlFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`NewAdlFile`=cp.`newfile` AND csnd.`NewAdlFile`=cp.`newfile1`)
                          ) UNION (SELECT DISTINCT `NewAdlFile` AS src, `NewAdlFile` AS tgt
                              FROM `File`
                              WHERE `NewAdlFile` IS NOT NULL AND `NewAdlFile` IS NOT NULL
    ...
    , 'tot newfile' =>
        array ( 'name' => 'tot newfile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"newfile;newfile~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`User` AS src, csnd.`User` AS tgt
                              FROM `User` AS cfst,
                                   `User` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `User` AS cp
                                WHERE cfst.`User`=cp.`User` AND csnd.`User`=cp.`User`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"newfile\",\"newfile~\"] */
                              
                              SELECT DISTINCT ECps0.`User` AS src, ECps1.`User` AS tgt
                              FROM `User` AS ECps0,
    ...
    , 'uni savepopulation' =>
        array ( 'name' => 'uni savepopulation'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(savepopulation~;savepopulation)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"savepopulation~;savepopulation\" ] */
                              SELECT DISTINCT cfst.`SavePopFile` AS src, csnd.`SavePopFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`SavePopFile`=cp.`savepopulation` AND csnd.`SavePopFile`=cp.`savepopulation1`)
                          ) UNION (SELECT DISTINCT `SavePopFile` AS src, `SavePopFile` AS tgt
                              FROM `File`
        ...
        array ( 'name' => 'tot savepopulation'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE NOT EXISTS (SELECT * FROM 
                                      ...
                                      WHERE isect0.`ctxnm`=cp.`ctxnm` AND isect0.`ctxnm`=cp.`ctxnm1`) AND isect0.`ctxnm` IS NOT NULL AND isect0.`ctxnm` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"savepopulation;savepopulation~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`ctxnm` AS src, csnd.`ctxnm` AS tgt
                              FROM `Conid` AS cfst,
    ...
    , 'uni savecontext' =>
        array ( 'name' => 'uni savecontext'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(savecontext~;savecontext)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"savecontext~;savecontext\" ] */
                              SELECT DISTINCT cfst.`SaveAdlFile` AS src, csnd.`SaveAdlFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`SaveAdlFile`=cp.`savecontext` AND csnd.`SaveAdlFile`=cp.`savecontext1`)
                          ) UNION (SELECT DISTINCT `SaveAdlFile` AS src, `SaveAdlFile` AS tgt
                              FROM `File`
        ...
        array ( 'name' => 'tot savecontext'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE NOT EXISTS (SELECT * FROM 
                                      ...
                                      WHERE isect0.`ctxnm`=cp.`ctxnm` AND isect0.`ctxnm`=cp.`ctxnm1`) AND isect0.`ctxnm` IS NOT NULL AND isect0.`ctxnm` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"savecontext;savecontext~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`ctxnm` AS src, csnd.`ctxnm` AS tgt
                              FROM `Conid` AS cfst,
    ...
    , 'uni AdlFile' =>
        array ( 'name' => 'uni AdlFile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(AdlFile~;AdlFile)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"AdlFile~;AdlFile\" ] */
                              SELECT DISTINCT cfst.`File` AS src, csnd.`File` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
        ...
        array ( 'name' => 'tot AdlFile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `File` AS cp
                                WHERE cfst.`AdlFile`=cp.`AdlFile` AND csnd.`AdlFile`=cp.`AdlFile`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"AdlFile\",\"AdlFile~\"] */
                              
                              SELECT DISTINCT ECps0.`AdlFile` AS src, ECps1.`AdlFile` AS tgt
                              FROM `File` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`AdlFile`=cp.`AdlFile` AND csnd.`AdlFile`=cp.`AdlFile1`)
                          ) UNION (SELECT DISTINCT `AdlFile` AS src, `AdlFile` AS tgt
                              FROM `File`
                              WHERE `AdlFile` IS NOT NULL AND `AdlFile` IS NOT NULL
    ...
    , 'uni NewAdlFile' =>
        array ( 'name' => 'uni NewAdlFile'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE isect0.`AdlFile` <> isect0.`AdlFile1` AND isect0.`AdlFile` IS NOT NULL AND isect0.`AdlFile1` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(NewAdlFile~;NewAdlFile)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"NewAdlFile~;NewAdlFile\" ] */
                              SELECT DISTINCT cfst.`AdlFile` AS src, csnd.`AdlFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
        ...
        array ( 'name' => 'tot NewAdlFile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `File` AS cp
                                WHERE cfst.`NewAdlFile`=cp.`NewAdlFile` AND csnd.`NewAdlFile`=cp.`NewAdlFile`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"NewAdlFile\",\"NewAdlFile~\"] */
                              
                              SELECT DISTINCT ECps0.`NewAdlFile` AS src, ECps1.`NewAdlFile` AS tgt
                              FROM `File` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`NewAdlFile`=cp.`NewAdlFile` AND csnd.`NewAdlFile`=cp.`NewAdlFile1`)
                          ) UNION (SELECT DISTINCT `NewAdlFile` AS src, `NewAdlFile` AS tgt
                              FROM `File`
                              WHERE `NewAdlFile` IS NOT NULL AND `NewAdlFile` IS NOT NULL
    ...
    , 'uni SavePopFile' =>
        array ( 'name' => 'uni SavePopFile'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE isect0.`File` <> isect0.`File1` AND isect0.`File` IS NOT NULL AND isect0.`File1` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(SavePopFile~;SavePopFile)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"SavePopFile~;SavePopFile\" ] */
                              SELECT DISTINCT cfst.`File` AS src, csnd.`File` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
    ...
    , 'tot SavePopFile' =>
        array ( 'name' => 'tot SavePopFile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"SavePopFile;SavePopFile~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`SavePopFile` AS src, csnd.`SavePopFile` AS tgt
                              FROM `File` AS cfst,
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `File` AS cp
                                WHERE cfst.`SavePopFile`=cp.`SavePopFile` AND csnd.`SavePopFile`=cp.`SavePopFile`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"SavePopFile\",\"SavePopFile~\"] */
                              
                              SELECT DISTINCT ECps0.`SavePopFile` AS src, ECps1.`SavePopFile` AS tgt
                              FROM `File` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`SavePopFile`=cp.`SavePopFile` AND csnd.`SavePopFile`=cp.`SavePopFile1`)
                          ) UNION (SELECT DISTINCT `SavePopFile` AS src, `SavePopFile` AS tgt
                              FROM `File`
                              WHERE `SavePopFile` IS NOT NULL AND `SavePopFile` IS NOT NULL
    ...
    , 'uni SaveAdlFile' =>
        array ( 'name' => 'uni SaveAdlFile'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE isect0.`AdlFile` <> isect0.`AdlFile1` AND isect0.`AdlFile` IS NOT NULL AND isect0.`AdlFile1` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(SaveAdlFile~;SaveAdlFile)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"SaveAdlFile~;SaveAdlFile\" ] */
                              SELECT DISTINCT cfst.`AdlFile` AS src, csnd.`AdlFile` AS tgt
                              FROM `File` AS cfst,
                                   `File` AS csnd
                              WHERE NOT EXISTS
    ...
    , 'tot SaveAdlFile' =>
        array ( 'name' => 'tot SaveAdlFile'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"SaveAdlFile;SaveAdlFile~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`SaveAdlFile` AS src, csnd.`SaveAdlFile` AS tgt
                              FROM `File` AS cfst,
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `File` AS cp
                                WHERE cfst.`SaveAdlFile`=cp.`SaveAdlFile` AND csnd.`SaveAdlFile`=cp.`SaveAdlFile`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"SaveAdlFile\",\"SaveAdlFile~\"] */
                              
                              SELECT DISTINCT ECps0.`SaveAdlFile` AS src, ECps1.`SaveAdlFile` AS tgt
                              FROM `File` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`SaveAdlFile`=cp.`SaveAdlFile` AND csnd.`SaveAdlFile`=cp.`SaveAdlFile1`)
                          ) UNION (SELECT DISTINCT `SaveAdlFile` AS src, `SaveAdlFile` AS tgt
                              FROM `File`
                              WHERE `SaveAdlFile` IS NOT NULL AND `SaveAdlFile` IS NOT NULL
    ...
    , 'uni countrules' =>
        array ( 'name' => 'uni countrules'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(countrules~;countrules)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"countrules~;countrules\" ] */
                              SELECT DISTINCT cfst.`Int` AS src, csnd.`Int` AS tgt
                              FROM `Int` AS cfst,
                                   `Int` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Int`=cp.`countrules` AND csnd.`Int`=cp.`countrules1`)
                          ) UNION (SELECT DISTINCT `Int` AS src, `Int` AS tgt
                              FROM `Int`
                              WHERE `Int` IS NOT NULL AND `Int` IS NOT NULL
    ...
    , 'uni countdecls' =>
        array ( 'name' => 'uni countdecls'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(countdecls~;countdecls)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"countdecls~;countdecls\" ] */
                              SELECT DISTINCT cfst.`Int` AS src, csnd.`Int` AS tgt
                              FROM `Int` AS cfst,
                                   `Int` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Int`=cp.`countdecls` AND csnd.`Int`=cp.`countdecls1`)
                          ) UNION (SELECT DISTINCT `Int` AS src, `Int` AS tgt
                              FROM `Int`
                              WHERE `Int` IS NOT NULL AND `Int` IS NOT NULL
    ...
    , 'uni countcpts' =>
        array ( 'name' => 'uni countcpts'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(countcpts~;countcpts)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"countcpts~;countcpts\" ] */
                              SELECT DISTINCT cfst.`Int` AS src, csnd.`Int` AS tgt
                              FROM `Int` AS cfst,
                                   `Int` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Int`=cp.`countcpts` AND csnd.`Int`=cp.`countcpts1`)
                          ) UNION (SELECT DISTINCT `Int` AS src, `Int` AS tgt
                              FROM `Int`
                              WHERE `Int` IS NOT NULL AND `Int` IS NOT NULL
    ...
    , 'uni ptpic' =>
        array ( 'name' => 'uni ptpic'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"ptpic~;ptpic\" ] */
                              SELECT DISTINCT cfst.`Image` AS src, csnd.`Image` AS tgt
                              FROM `Image` AS cfst,
                                   `Image` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Image`=cp.`ptpic` AND csnd.`Image`=cp.`ptpic1`)
                          ) UNION (SELECT DISTINCT `Image` AS src, `Image` AS tgt
                              FROM `Image`
                              WHERE `Image` IS NOT NULL AND `Image` IS NOT NULL
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Image`=cp.`cptpic` AND csnd.`Image`=cp.`cptpic1`)
                          ) UNION (SELECT DISTINCT `Image` AS src, `Image` AS tgt
                              FROM `Image`
                              WHERE `Image` IS NOT NULL AND `Image` IS NOT NULL
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Image`=cp.`rrpic` AND csnd.`Image`=cp.`rrpic1`)
                          ) UNION (SELECT DISTINCT `Image` AS src, `Image` AS tgt
                              FROM `Image`
                              WHERE `Image` IS NOT NULL AND `Image` IS NOT NULL
    ...
    , 'uni Violation' =>
        array ( 'name' => 'uni Violation'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(Violation~;Violation)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"Violation~;Violation\" ] */
                              SELECT DISTINCT cfst.`PairID` AS src, csnd.`PairID` AS tgt
                              FROM `PairID` AS cfst,
                                   `PairID` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`PairID`=cp.`PairID` AND csnd.`PairID`=cp.`PairID1`)
                          ) UNION (SELECT DISTINCT `PairID` AS src, `PairID` AS tgt
                              FROM `PairID`
    ...
    , 'tot Violation' =>
        array ( 'name' => 'tot Violation'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"Violation;Violation~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`Violation` AS src, csnd.`Violation` AS tgt
                              FROM `PairID` AS cfst,
                                   `PairID` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `PairID` AS cp
                                WHERE cfst.`Violation`=cp.`Violation` AND csnd.`Violation`=cp.`Violation`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"Violation\",\"Violation~\"] */
                              
                              SELECT DISTINCT ECps0.`Violation` AS src, ECps1.`Violation` AS tgt
                              FROM `PairID` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Violation`=cp.`Violation` AND csnd.`Violation`=cp.`Violation1`)
                          ) UNION (SELECT DISTINCT `Violation` AS src, `Violation` AS tgt
                              FROM `PairID`
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`ctxnm`=cp.`ctxnm` AND csnd.`ctxnm`=cp.`ctxnm1`)
                          ) UNION (SELECT DISTINCT `ctxnm` AS src, `ctxnm` AS tgt
                              FROM `Conid`
    ...
    , 'uni ctxnm' =>
        array ( 'name' => 'uni ctxnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"ctxnm~;ctxnm\" ] */
                              SELECT DISTINCT cfst.`Conid` AS src, csnd.`Conid` AS tgt
                              FROM `Conid` AS cfst,
                                   `Conid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Conid`=cp.`Conid` AND csnd.`Conid`=cp.`Conid1`)
                          ) UNION (SELECT DISTINCT `Conid` AS src, `Conid` AS tgt
                              FROM `Conid`
                              WHERE `Conid` IS NOT NULL AND `Conid` IS NOT NULL
    ...
    , 'inj ptnm' =>
        array ( 'name' => 'inj ptnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"ptnm;ptnm~\" ] */
                              SELECT DISTINCT cfst.`ptnm` AS src, csnd.`ptnm` AS tgt
                              FROM `Conid` AS cfst,
                                   `Conid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`ptnm`=cp.`ptnm` AND csnd.`ptnm`=cp.`ptnm1`)
                          ) UNION (SELECT DISTINCT `ptnm` AS src, `ptnm` AS tgt
                              FROM `Conid`
        ...
        array ( 'name' => 'tot ptnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `Conid` AS cp
                                WHERE cfst.`ptnm`=cp.`ptnm` AND csnd.`ptnm`=cp.`ptnm`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"ptnm\",\"ptnm~\"] */
                              
                              SELECT DISTINCT ECps0.`ptnm` AS src, ECps1.`ptnm` AS tgt
                              FROM `Conid` AS ECps0,
    ...
    , 'uni gengen' =>
        array ( 'name' => 'uni gengen'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(gengen~;gengen)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"gengen~;gengen\" ] */
                              SELECT DISTINCT cfst.`cptnm` AS src, csnd.`cptnm` AS tgt
                              FROM `Conid` AS cfst,
                                   `Conid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`gengen` AND csnd.`cptnm`=cp.`gengen1`)
                          ) UNION (SELECT DISTINCT `cptnm` AS src, `cptnm` AS tgt
                              FROM `Conid`
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              FROM `Gen` AS cfst,
                                   `Gen` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `Gen` AS cp
                                WHERE cfst.`Gen`=cp.`Gen` AND csnd.`Gen`=cp.`Gen`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"gengen\",\"gengen~\"] */
                              
                              SELECT DISTINCT ECps0.`Gen` AS src, ECps1.`Gen` AS tgt
                              FROM `Gen` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`genspc` AND csnd.`cptnm`=cp.`genspc1`)
                          ) UNION (SELECT DISTINCT `cptnm` AS src, `cptnm` AS tgt
                              FROM `Conid`
                              WHERE `cptnm` IS NOT NULL AND `cptnm` IS NOT NULL
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`cptnm` AND csnd.`cptnm`=cp.`cptnm1`)
                          ) UNION (SELECT DISTINCT `cptnm` AS src, `cptnm` AS tgt
                              FROM `Conid`
                              WHERE `cptnm` IS NOT NULL AND `cptnm` IS NOT NULL
        ...
        array ( 'name' => 'tot cptnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `Conid` AS cp
                                WHERE cfst.`cptnm`=cp.`cptnm` AND csnd.`cptnm`=cp.`cptnm`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"cptnm\",\"cptnm~\"] */
                              
                              SELECT DISTINCT ECps0.`cptnm` AS src, ECps1.`cptnm` AS tgt
                              FROM `Conid` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`cptos` AND csnd.`cptnm`=cp.`cptos1`)
                          ) UNION (SELECT DISTINCT `cptnm` AS src, `cptnm` AS tgt
                              FROM `Conid`
                              WHERE `cptnm` IS NOT NULL AND `cptnm` IS NOT NULL
    ...
    , 'uni atomvalue' =>
        array ( 'name' => 'uni atomvalue'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(atomvalue~;atomvalue)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"atomvalue~;atomvalue\" ] */
                              SELECT DISTINCT cfst.`Atom` AS src, csnd.`Atom` AS tgt
                              FROM `Atom` AS cfst,
                                   `Atom` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Atom`=cp.`atomvalue` AND csnd.`Atom`=cp.`atomvalue1`)
                          ) UNION (SELECT DISTINCT `Atom` AS src, `Atom` AS tgt
                              FROM `Atom`
    ...
    , 'tot atomvalue' =>
        array ( 'name' => 'tot atomvalue'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"atomvalue;atomvalue~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`AtomID` AS src, csnd.`AtomID` AS tgt
                              FROM `AtomID` AS cfst,
                                   `AtomID` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `AtomID` AS cp
                                WHERE cfst.`AtomID`=cp.`AtomID` AND csnd.`AtomID`=cp.`AtomID`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"atomvalue\",\"atomvalue~\"] */
                              
                              SELECT DISTINCT ECps0.`AtomID` AS src, ECps1.`AtomID` AS tgt
                              FROM `AtomID` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`src` AND csnd.`cptnm`=cp.`src1`)
                          ) UNION (SELECT DISTINCT `cptnm` AS src, `cptnm` AS tgt
                              FROM `Conid`
                              WHERE `cptnm` IS NOT NULL AND `cptnm` IS NOT NULL
    ...
    , 'tot src' =>
        array ( 'name' => 'tot src'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`Sign` AS src, csnd.`Sign` AS tgt
                              FROM `Sign` AS cfst,
                                   `Sign` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `Sign` AS cp
                                WHERE cfst.`Sign`=cp.`Sign` AND csnd.`Sign`=cp.`Sign`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"src\",\"src~\"] */
                              
                              SELECT DISTINCT ECps0.`Sign` AS src, ECps1.`Sign` AS tgt
                              FROM `Sign` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`cptnm`=cp.`trg` AND csnd.`cptnm`=cp.`trg1`)
                          ) UNION (SELECT DISTINCT `cptnm` AS src, `cptnm` AS tgt
                              FROM `Conid`
                              WHERE `cptnm` IS NOT NULL AND `cptnm` IS NOT NULL
    ...
    , 'uni pairvalue' =>
        array ( 'name' => 'uni pairvalue'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(pairvalue~;pairvalue)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"pairvalue~;pairvalue\" ] */
                              SELECT DISTINCT cfst.`Pair` AS src, csnd.`Pair` AS tgt
                              FROM `Pair` AS cfst,
                                   `Pair` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Pair`=cp.`pairvalue` AND csnd.`Pair`=cp.`pairvalue1`)
                          ) UNION (SELECT DISTINCT `Pair` AS src, `Pair` AS tgt
                              FROM `Pair`
                              WHERE `Pair` IS NOT NULL AND `Pair` IS NOT NULL
        ...
        array ( 'name' => 'tot pairvalue'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `PairID` AS cp
                                WHERE cfst.`PairID`=cp.`PairID` AND csnd.`PairID`=cp.`PairID`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"pairvalue\",\"pairvalue~\"] */
                              
                              SELECT DISTINCT ECps0.`PairID` AS src, ECps1.`PairID` AS tgt
                              FROM `PairID` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`AtomID`=cp.`left` AND csnd.`AtomID`=cp.`left1`)
                          ) UNION (SELECT DISTINCT `AtomID` AS src, `AtomID` AS tgt
                              FROM `AtomID`
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              FROM `Pair` AS cfst,
                                   `Pair` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `Pair` AS cp
                                WHERE cfst.`Pair`=cp.`Pair` AND csnd.`Pair`=cp.`Pair`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"left\",\"left~\"] */
                              
                              SELECT DISTINCT ECps0.`Pair` AS src, ECps1.`Pair` AS tgt
                              FROM `Pair` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`AtomID`=cp.`right` AND csnd.`AtomID`=cp.`right1`)
                          ) UNION (SELECT DISTINCT `AtomID` AS src, `AtomID` AS tgt
                              FROM `AtomID`
                              WHERE `AtomID` IS NOT NULL AND `AtomID` IS NOT NULL
    ...
    , 'uni decnm' =>
        array ( 'name' => 'uni decnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"decnm~;decnm\" ] */
                              SELECT DISTINCT cfst.`Varid` AS src, csnd.`Varid` AS tgt
                              FROM `Varid` AS cfst,
                                   `Varid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Varid`=cp.`decnm` AND csnd.`Varid`=cp.`decnm1`)
                          ) UNION (SELECT DISTINCT `Varid` AS src, `Varid` AS tgt
                              FROM `Varid`
                              WHERE `Varid` IS NOT NULL AND `Varid` IS NOT NULL
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              FROM `Declaration` AS cfst,
                                   `Declaration` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `Declaration` AS cp
                                WHERE cfst.`Declaration`=cp.`Declaration` AND csnd.`Declaration`=cp.`Declaration`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"decnm\",\"decnm~\"] */
                              
                              SELECT DISTINCT ECps0.`Declaration` AS src, ECps1.`Declaration` AS tgt
                              FROM `Declaration` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Sign`=cp.`decsgn` AND csnd.`Sign`=cp.`decsgn1`)
                          ) UNION (SELECT DISTINCT `Sign` AS src, `Sign` AS tgt
                              FROM `Sign`
                              WHERE `Sign` IS NOT NULL AND `Sign` IS NOT NULL
    ...
    , 'inj decprps' =>
        array ( 'name' => 'inj decprps'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(decprps;decprps~)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"decprps;decprps~\" ] */
                              SELECT DISTINCT cfst.`Declaration` AS src, csnd.`Declaration` AS tgt
                              FROM `Declaration` AS cfst,
                                   `Declaration` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Declaration`=cp.`decprps` AND csnd.`Declaration`=cp.`decprps1`)
                          ) UNION (SELECT DISTINCT `Declaration` AS src, `Declaration` AS tgt
                              FROM `Declaration`
                              WHERE `Declaration` IS NOT NULL AND `Declaration` IS NOT NULL
    ...
    , 'tot declaredthrough' =>
        array ( 'name' => 'tot declaredthrough'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"declaredthrough;declaredthrough~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`PropertyRule` AS src, csnd.`PropertyRule` AS tgt
                              FROM `ADLid` AS cfst,
                                   `ADLid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `ADLid` AS cp
                                WHERE cfst.`PropertyRule`=cp.`PropertyRule` AND csnd.`PropertyRule`=cp.`PropertyRule`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"declaredthrough\",\"declaredthrough~\"] */
                              
                              SELECT DISTINCT ECps0.`PropertyRule` AS src, ECps1.`PropertyRule` AS tgt
                              FROM `declaredthrough` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`String`=cp.`decprL` AND csnd.`String`=cp.`decprL1`)
                          ) UNION (SELECT DISTINCT `String` AS src, `String` AS tgt
                              FROM `String`
                              WHERE `String` IS NOT NULL AND `String` IS NOT NULL
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`String`=cp.`decprM` AND csnd.`String`=cp.`decprM1`)
                          ) UNION (SELECT DISTINCT `String` AS src, `String` AS tgt
                              FROM `String`
                              WHERE `String` IS NOT NULL AND `String` IS NOT NULL
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`String`=cp.`decprR` AND csnd.`String`=cp.`decprR1`)
                          ) UNION (SELECT DISTINCT `String` AS src, `String` AS tgt
                              FROM `String`
                              WHERE `String` IS NOT NULL AND `String` IS NOT NULL
    ...
    , 'uni PropertyRule' =>
        array ( 'name' => 'uni PropertyRule'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(PropertyRule~;PropertyRule)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"PropertyRule~;PropertyRule\" ] */
                              SELECT DISTINCT cfst.`rrnm` AS src, csnd.`rrnm` AS tgt
                              FROM `ADLid` AS cfst,
                                   `ADLid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`rrnm`=cp.`rrnm` AND csnd.`rrnm`=cp.`rrnm1`)
                          ) UNION (SELECT DISTINCT `rrnm` AS src, `rrnm` AS tgt
                              FROM `ADLid`
        ...
        array ( 'name' => 'tot PropertyRule'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE NOT EXISTS (SELECT * FROM 
                                      ...
                                      WHERE isect0.`PropertyRule`=cp.`PropertyRule` AND isect0.`PropertyRule`=cp.`PropertyRule1`) AND isect0.`PropertyRule` IS NOT NULL AND isect0.`PropertyRule` IS NOT NULL'
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"PropertyRule;PropertyRule~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`PropertyRule` AS src, csnd.`PropertyRule` AS tgt
                              FROM `ADLid` AS cfst,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`PropertyRule`=cp.`PropertyRule` AND csnd.`PropertyRule`=cp.`PropertyRule1`)
                          ) UNION (SELECT DISTINCT `PropertyRule` AS src, `PropertyRule` AS tgt
                              FROM `ADLid`
    ...
    , 'uni exprvalue' =>
        array ( 'name' => 'uni exprvalue'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-(exprvalue~;exprvalue)\",\"I\"] */
                          (/* case: ECpl e
                                 ECpl [ \"exprvalue~;exprvalue\" ] */
                              SELECT DISTINCT cfst.`Expression` AS src, csnd.`Expression` AS tgt
                              FROM `Expression` AS cfst,
                                   `Expression` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                     ( /* case: (ECps es), with two or more elements in es.
                                ...
                                WHERE cfst.`Expression`=cp.`exprvalue` AND csnd.`Expression`=cp.`exprvalue1`)
                          ) UNION (SELECT DISTINCT `Expression` AS src, `Expression` AS tgt
                              FROM `Expression`
                              WHERE `Expression` IS NOT NULL AND `Expression` IS NOT NULL
    ...
    , 'tot exprvalue' =>
        array ( 'name' => 'tot exprvalue'
              ...
              , 'contentsSQL' => '/* case: EUni es
                             EUni [\"-I\",\"exprvalue;exprvalue~\"] */
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`ExpressionID` AS src, csnd.`ExpressionID` AS tgt
                              FROM `ExpressionID` AS cfst,
                                   `ExpressionID` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `ExpressionID` AS cp
                                WHERE cfst.`ExpressionID`=cp.`ExpressionID` AND csnd.`ExpressionID`=cp.`ExpressionID`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"exprvalue\",\"exprvalue~\"] */
                              
                              SELECT DISTINCT ECps0.`ExpressionID` AS src, ECps1.`ExpressionID` AS tgt
                              FROM `ExpressionID` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Varid`=cp.`relnm` AND csnd.`Varid`=cp.`relnm1`)
                          ) UNION (SELECT DISTINCT `Varid` AS src, `Varid` AS tgt
                              FROM `Varid`
                              WHERE `Varid` IS NOT NULL AND `Varid` IS NOT NULL
    ...
    , 'tot relnm' =>
        array ( 'name' => 'tot relnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"I\" ] */
                              SELECT DISTINCT cfst.`Relation` AS src, csnd.`Relation` AS tgt
                              FROM `Relation` AS cfst,
                                   `Relation` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM `Relation` AS cp
                                WHERE cfst.`Relation`=cp.`Relation` AND csnd.`Relation`=cp.`Relation`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"relnm\",\"relnm~\"] */
                              
                              SELECT DISTINCT ECps0.`Relation` AS src, ECps1.`Relation` AS tgt
                              FROM `Relation` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Sign`=cp.`relsgn` AND csnd.`Sign`=cp.`relsgn1`)
                          ) UNION (SELECT DISTINCT `Sign` AS src, `Sign` AS tgt
                              FROM `Sign`
                              WHERE `Sign` IS NOT NULL AND `Sign` IS NOT NULL
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`Declaration`=cp.`reldcl` AND csnd.`Declaration`=cp.`reldcl1`)
                          ) UNION (SELECT DISTINCT `Declaration` AS src, `Declaration` AS tgt
                              FROM `Declaration`
                              WHERE `Declaration` IS NOT NULL AND `Declaration` IS NOT NULL
    ...
    , 'uni rrnm' =>
        array ( 'name' => 'uni rrnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                                 ECpl [ \"rrnm~;rrnm\" ] */
                              SELECT DISTINCT cfst.`ADLid` AS src, csnd.`ADLid` AS tgt
                              FROM `ADLid` AS cfst,
                                   `ADLid` AS csnd
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`ADLid`=cp.`ADLid` AND csnd.`ADLid`=cp.`ADLid1`)
                          ) UNION (SELECT DISTINCT `ADLid` AS src, `ADLid` AS tgt
                              FROM `ADLid`
                              WHERE `ADLid` IS NOT NULL AND `ADLid` IS NOT NULL
        ...
        array ( 'name' => 'tot rrnm'
              ...
              , 'contentsSQL' => '/* case: EUni es
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM `ADLid` AS cp
                                WHERE cfst.`rrnm`=cp.`rrnm` AND csnd.`rrnm`=cp.`rrnm`)
                          ) UNION (/* case: (ECps es), with two or more elements in es.
                                 ECps [\"rrnm\",\"rrnm~\"] */
                              
                              SELECT DISTINCT ECps0.`rrnm` AS src, ECps1.`rrnm` AS tgt
                              FROM `ADLid` AS ECps0,
                          ...
                          (/* case: ECpl e
                              ...
                              WHERE NOT EXISTS
                               (SELECT * FROM 
                                ...
                                WHERE cfst.`ExpressionID`=cp.`rrexp` AND csnd.`ExpressionID`=cp.`rrexp1`)
                          ) UNION (SELECT DISTINCT `ExpressionID` AS src, `ExpressionID` AS tgt
                              FROM `ExpressionID`
                              WHERE `ExpressionID` IS NOT NULL AND `ExpressionID` IS NOT NULL
