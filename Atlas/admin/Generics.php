...
// Prototype v2.2.0.2003:2004M, build time: 5-Apr-12 11:40.59 (lib: Ampersand v2.2.0.560M, build time: 5-Apr-12 9:33.26)


$versionInfo = 'Prototype v2.2.0.2003:2004M, build time: 5-Apr-12 11:40.59 (lib: Ampersand v2.2.0.560M, build time: 5-Apr-12 9:33.26)';
...
$relationTableInfo =
  array
    ...
    , 'decprL' => array ('srcConcept' => 'Declaration', 'tgtConcept' => 'String', 'table' => 'nssharedDeclaration', 'srcCol' => 'Declaration', 'tgtCol' => 'decprL')
    , 'decprM' => array ('srcConcept' => 'Declaration', 'tgtConcept' => 'String', 'table' => 'nssharedDeclaration', 'srcCol' => 'Declaration', 'tgtCol' => 'decprM')
    , 'decprR' => array ('srcConcept' => 'Declaration', 'tgtConcept' => 'String', 'table' => 'nssharedDeclaration', 'srcCol' => 'Declaration', 'tgtCol' => 'decprR')
    , 'decpopu' => array ('srcConcept' => 'Declaration', 'tgtConcept' => 'PairID', 'table' => 'nsshareddecpopu', 'srcCol' => 'Declaration', 'tgtCol' => 'PairID')
    , 'pairvalue' => array ('srcConcept' => 'PairID', 'tgtConcept' => 'Pair', 'table' => 'nssharedPairID', 'srcCol' => 'PairID', 'tgtCol' => 'pairvalue')
    , 'left' => array ('srcConcept' => 'Pair', 'tgtConcept' => 'AtomID', 'table' => 'nssharedPair', 'srcCol' => 'Pair', 'tgtCol' => 'left')
    , 'right' => array ('srcConcept' => 'Pair', 'tgtConcept' => 'AtomID', 'table' => 'nssharedPair', 'srcCol' => 'Pair', 'tgtCol' => 'right')
    ...
    , 'compilererror' => array ('srcConcept' => 'File', 'tgtConcept' => 'ErrorMessage', 'table' => 'nssharedFile', 'srcCol' => 'File', 'tgtCol' => 'compilererror')
    ...
    , 'inios' => array ('srcConcept' => 'Concept', 'tgtConcept' => 'AtomID', 'table' => 'nssharedinios', 'srcCol' => 'Concept', 'tgtCol' => 'AtomID')
...
$allRulesSql =
  array
    ...
    , 'usedatom' =>
        array ( 'name' => 'usedatom'
              , 'ruleAdl' => 'src~;decsgn~;decpopu;pairvalue;left \\/ trg~;decsgn~;decpopu;pairvalue;right |- cptos'
              , 'origin' => 'line 132, file "AST.adl"'
              , 'meaning' => ''
              , 'message' => 'Een atoom dat u uit de populatie van het concept probeert te verwijderen heeft nog relaties.'
              , 'srcConcept' => 'Concept'
              , 'tgtConcept' => 'AtomID'
              // Normalized complement (== violationsSQL): (src~;decsgn~;decpopu;pairvalue;left \\/ trg~;decsgn~;decpopu;pairvalue;right)/\\-cptos
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"src~;decsgn~;decpopu;pairvalue;left \\\\/ trg~;decsgn~;decpopu;pairvalue;right\",\"-cptos\"] */
                          SELECT DISTINCT isect0.`src`, isect0.`left` AS tgt
                          FROM 
                               ( /* case: EUni es
                                    EUni [\"src~;decsgn~;decpopu;pairvalue;left\",\"trg~;decsgn~;decpopu;pairvalue;right\"] */
                                 (/* case: (ECps es), with two or more elements in es.
                                        ECps [\"src~\",\"decsgn~\",\"decpopu\",\"pairvalue\",\"left\"] */
                                     
                                     SELECT DISTINCT ECps0.`src`, ECps4.`left`
                                     FROM 
                                          ( /* case: EFlp x. */
    ...
    , 'conceptwijzigingen2' =>
        array ( 'name' => 'conceptwijzigingen2'
              ...
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                          ...
                          WHERE NOT EXISTS (SELECT * FROM `nssharedinios` AS cp
    ...
    , 'conceptverwijderen' =>
        array ( 'name' => 'conceptverwijderen'
              , 'ruleAdl' => 'cptos |- src~;decsgn~;decpopu;pairvalue;left \\/ trg~;decsgn~;decpopu;pairvalue;right'
              , 'origin' => 'line 40, file "rap.adl"'
              , 'meaning' => ''
              , 'message' => 'De volgende atomen hebben geen enkele relatie met atomen. Deze atomen zullen niet meer bestaan in de versie waarin u atlasbewerkingen opslaat via \\textless{}i\\textgreater{}Atlasbewerkingen effectueren\\textless{}/i\\textgreater{}.'
              , 'srcConcept' => 'Concept'
              , 'tgtConcept' => 'AtomID'
              // Normalized complement (== violationsSQL): cptos/\\-(src~;decsgn~;decpopu;pairvalue;left)/\\-(trg~;decsgn~;decpopu;pairvalue;right)
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"cptos\",\"-(src~;decsgn~;decpopu;pairvalue;left)\",\"-(trg~;decsgn~;decpopu;pairvalue;right)\"] */
                          SELECT DISTINCT isect0.`cptos` AS src, isect0.`AtomID` AS tgt
                          FROM `nssharedAtomID` AS isect0
                          WHERE NOT EXISTS (SELECT * FROM 
                                           ( /* case: (ECps es), with two or more elements in es.
                                      ...
                                      WHERE isect0.`cptos`=cp.`src` AND isect0.`AtomID`=cp.`left`) AND NOT EXISTS (SELECT * FROM 
                                           ( /* case: (ECps es), with two or more elements in es.
                                             ...
                                             SELECT DISTINCT ECps0.`trg`, ECps4.`right`
                                             FROM 
                                                  ( /* case: EFlp x. */
                                                    SELECT DISTINCT `Sign`, `trg`
                                                    FROM `nssharedSign`
                          ...
                          FROM 
                               ...
                               ( /* case: EUni es
                                 ...
                                 (/* case: ECpl e
                                     ...
                                     FROM `nssharedDeclaration` AS cfst,
                                          `nssharedPairID` AS csnd
                                     WHERE NOT EXISTS
                                      (SELECT * FROM `nsshareddecpopu` AS cp
                                     ...
                                     FROM `nssharedDeclaration` AS cfst,
                                          `nssharedPairID` AS csnd
                                     WHERE NOT EXISTS
                                      (SELECT * FROM `nssharedinipopu` AS cp
                                       WHERE cfst.`Declaration`=cp.`Declaration` AND csnd.`PairID`=cp.`PairID`)
    ...
    , 'parseoftypefout' =>
        array ( 'name' => 'parseoftypefout'
              ...
              , 'origin' => 'line 44, file "rap.adl"'
              , 'meaning' => ''
              , 'message' => '\\textless{}b\\textgreater{}Het bronbestand veroorzaakt een parse- of typefout (zie rechterlid).\\textless{}/b\\textgreater{} Er is daarom geen context in de Atlas geladen. Klik op de bestandsnaam (zie linkerlid) om het bronbestand te openen en eventueel te verbeteren.'
              , 'srcConcept' => 'File'
