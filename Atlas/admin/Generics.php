...
// Prototype v2.2.0.2065:2066M, build time: 19-Apr-12 10:39.54 (lib: Ampersand v2.2.0.567:568M, build time: 19-Apr-12 10:38.43)


$versionInfo = 'Prototype v2.2.0.2065:2066M, build time: 19-Apr-12 10:39.54 (lib: Ampersand v2.2.0.567:568M, build time: 19-Apr-12 10:38.43)';
...
$relationTableInfo =
  array
    ...
    , 'cptos' => array ('srcConcept' => 'Concept', 'tgtConcept' => 'AtomID', 'table' => 'nssharedAtomID', 'srcCol' => 'cptos', 'tgtCol' => 'AtomID')
    ...
    , 'te_message' => array ('srcConcept' => 'TypeError', 'tgtConcept' => 'String', 'table' => 'nssharedTypeError1', 'srcCol' => 'TypeError', 'tgtCol' => 'te_message')
  ...
  array
    ...
    , 'nssharedTypeError1' =>
        array
          ...
          , 'te_message' => array ( 'concept' => 'String', 'unique' => false, 'null' => true)
  ...
  array
    ( 'uniek path/filename' =>
        array ( 'name' => 'uniek path/filename'
              ...
              , 'origin' => 'line 16, file "Fspec.adl"'
              , 'meaning' => ''
              , 'message' => 'The path/name combination of files is not unique for all files.'
              , 'srcConcept' => 'File'
              , 'tgtConcept' => 'File'
    ...
    , 'usedatom' =>
        array ( 'name' => 'usedatom'
              , 'ruleAdl' => 'src~;decsgn~;decpopu;left \\/ trg~;decsgn~;decpopu;right |- cptos'
              , 'origin' => 'line 135, file "AST.adl"'
              , 'meaning' => ''
              ...
              , 'srcConcept' => 'Concept'
              , 'tgtConcept' => 'AtomID'
              // Normalized complement (== violationsSQL): (src~;decsgn~;decpopu;left \\/ trg~;decsgn~;decpopu;right)/\\-cptos
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"src~;decsgn~;decpopu;left \\\\/ trg~;decsgn~;decpopu;right\",\"-cptos\"] */
                          ...
                          WHERE NOT EXISTS (SELECT * FROM `nssharedAtomID` AS cp
                                      WHERE isect0.`src`=cp.`cptos` AND isect0.`left`=cp.`AtomID`) AND isect0.`src` IS NOT NULL AND isect0.`left` IS NOT NULL'
              , 'pairView' =>
                  array
                    ( array ( 'segmentType' => 'Exp'
                            , 'srcOrTgt' => 'Src'
    ...
    , 'key atom of concept' =>
        array ( 'name' => 'key atom of concept'
              , 'ruleAdl' => 'atomvalue;atomvalue~/\\cptos~;cptos |- I'
              ...
              , 'srcConcept' => 'AtomID'
              , 'tgtConcept' => 'AtomID'
              // Normalized complement (== violationsSQL): atomvalue;atomvalue~/\\cptos~;cptos/\\-I
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"atomvalue;atomvalue~\",\"cptos~;cptos\",\"-I\"] */
    ...
    , 'key relationship' =>
        array ( 'name' => 'key relationship'
              , 'ruleAdl' => 'left;left~/\\right;right~/\\decpopu~;decpopu |- I'
              , 'origin' => 'line 233, file "AST.adl"'
              , 'meaning' => 'At most one of the pair identifiers with the same left and right may exist in the population of a relation declarion.'
    ...
    , 'typed domain' =>
        array ( 'name' => 'typed domain'
              , 'ruleAdl' => 'decpopu;left;cptos~ |- decsgn;src \\/ decsgn;src;(genspc~;gengen \\/ genspc~;gengen;genspc~;gengen \\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~'
              , 'origin' => 'line 239, file "AST.adl"'
              , 'meaning' => 'The type of the elements in the domain of a declaration is the source of that relation.'
              , 'message' => 'You try to add a tuple with a source, that does not match the source of the declaration. This is a violation of the type of the relation. TIP: enter the source of the declaration in the left input field to get a shorter pick list. Note on ISA-relations: If you try to use an atom of a more generic concept, than you need to make the atom more specific first c.q. at least as specific as the source of the declaration. You can make an atom more specific by adding it to the population of a more specific concept.'
              , 'srcConcept' => 'Declaration'
              , 'tgtConcept' => 'Concept'
              // Normalized complement (== violationsSQL): decpopu;left;cptos~/\\-(decsgn;src)/\\-(decsgn;src;(genspc~;gengen \\/ genspc~;gengen;genspc~;gengen \\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~)
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"decpopu;left;cptos~\",\"-(decsgn;src)\",\"-(decsgn;src;(genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~)\"] */
                          SELECT DISTINCT isect0.`Declaration` AS src, isect0.`cptos` AS tgt
                          FROM 
                               ( /* case: (ECps es), with two or more elements in es.
                                    ECps [\"decpopu\",\"left\",\"cptos~\"] */
                                 
                                 SELECT DISTINCT ECps0.`Declaration`, ECps2.`cptos`
              ...
              , 'pairView' =>
                  array
                    ( array ( 'segmentType' => 'Text', 'Text' => 'Type of atom ')
                    , array ( 'segmentType' => 'Exp'
                            , 'srcOrTgt' => 'Tgt'
                            , 'expTgt' => 'Concept'
                            , 'expSQL' =>
                    ...
                    , array ( 'segmentType' => 'Text', 'Text' => ' does not match source ')
                    , array ( 'segmentType' => 'Exp'
                            , 'srcOrTgt' => 'Src'
                            , 'expTgt' => 'Concept'
                            , 'expSQL' =>
    ...
    , 'typed codomain' =>
        array ( 'name' => 'typed codomain'
              , 'ruleAdl' => 'decpopu;right;cptos~ |- decsgn;trg \\/ decsgn;trg;(genspc~;gengen \\/ genspc~;gengen;genspc~;gengen \\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~'
              , 'origin' => 'line 244, file "AST.adl"'
              ...
              , 'srcConcept' => 'Declaration'
              , 'tgtConcept' => 'Concept'
              // Normalized complement (== violationsSQL): decpopu;right;cptos~/\\-(decsgn;trg)/\\-(decsgn;trg;(genspc~;gengen \\/ genspc~;gengen;genspc~;gengen \\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~)
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"decpopu;right;cptos~\",\"-(decsgn;trg)\",\"-(decsgn;trg;(genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen \\\\/ genspc~;gengen;genspc~;gengen;genspc~;gengen)~)\"] */
                          SELECT DISTINCT isect0.`Declaration` AS src, isect0.`cptos` AS tgt
                          FROM 
                               ( /* case: (ECps es), with two or more elements in es.
                                    ECps [\"decpopu\",\"right\",\"cptos~\"] */
    ...
    , 'conceptverwijderen' =>
        array ( 'name' => 'conceptverwijderen'
              , 'ruleAdl' => 'cptos |- src~;decsgn~;decpopu;left \\/ trg~;decsgn~;decpopu;right'
              , 'origin' => 'line 46, file "rap.adl"'
              , 'meaning' => ''
              ...
              , 'srcConcept' => 'Concept'
              , 'tgtConcept' => 'AtomID'
              // Normalized complement (== violationsSQL): cptos/\\-(src~;decsgn~;decpopu;left)/\\-(trg~;decsgn~;decpopu;right)
              , 'violationsSQL' => '/* case: (EIsc lst@(_:_:_))
                             EIsc [\"cptos\",\"-(src~;decsgn~;decpopu;left)\",\"-(trg~;decsgn~;decpopu;right)\"] */
                          ...
                          WHERE NOT EXISTS (SELECT * FROM 
                                      ...
                                      WHERE isect0.`cptos`=cp.`src` AND isect0.`AtomID`=cp.`left`) AND NOT EXISTS (SELECT * FROM 
                                           ( /* case: (ECps es), with two or more elements in es.
                                                ECps [\"trg~\",\"decsgn~\",\"decpopu\",\"right\"] */
                                             
                                             SELECT DISTINCT ECps0.`trg`, ECps3.`right`
                                             FROM 
                                                  ( /* case: EFlp x. */
                                                    SELECT DISTINCT `Sign`, `trg`
                                                    FROM `nssharedSign`
                                      ...
                                      WHERE isect0.`cptos`=cp.`trg` AND isect0.`AtomID`=cp.`right`) AND isect0.`cptos` IS NOT NULL AND isect0.`AtomID` IS NOT NULL'
              , 'pairView' =>
                  array
                    ( array ( 'segmentType' => 'Exp'
                            , 'srcOrTgt' => 'Tgt'
    ...
    , 'overtredingen' =>
        array ( 'name' => 'overtredingen'
              ...
              , 'origin' => 'line 20, file "student_AST_interfaces.adl"'
              , 'meaning' => ''
    ...
    , 'UNI te_message::TypeError*String' =>
        array ( 'name' => 'UNI te_message::TypeError*String'
              , 'ruleAdl' => 'te_message~;te_message |- I'
              , 'origin' => 'line 75, file "rap.adl"'
              , 'meaning' => 'te\\_message[TypeError\\*String] is univalent'
              , 'message' => 'te\\_message[TypeError\\*String] is niet univalent'
              , 'srcConcept' => 'String'
              , 'tgtConcept' => 'String'
    ...
    , 'INJ cptos::Concept*AtomID' =>
        array ( 'name' => 'INJ cptos::Concept*AtomID'
      ...
      array ( 'name' => 'Concept'
            ...
            , 'boxSubInterfaces' =>
                array
                  ...
                  , array ( 'name' => 'more specific concepts'
                  ...
                  , array ( 'name' => 'POPULATION (of more specific)'
