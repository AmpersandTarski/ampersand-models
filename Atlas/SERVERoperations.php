...
$commandstr = array(
     1 => './adl567-2059 -p'.COMPILATIONS_PATH.' --css=RAP.css --import="'.FULLFILE.'" --fileformat=ADL1 --namespace='.USER.' --dbName=atlas --sqlHost=145.20.32.24 --sqlLogin=atlas --sqlPwd=albu3m RAP.adl', //load
