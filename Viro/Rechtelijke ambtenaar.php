...
\***************************************/
  ...
  require "Rechtelijke ambtenaar.inc.php";
  ...
  if(isset($_REQUEST['save'])) { // handle ajax save request (do not show the interface)
    ...
    $Rechtelijkeambtenaar=new Rechtelijkeambtenaar($ID,$lid, $rol, $geautoriseerdvoor, $Zittingen, $ontvangen, $verzonden);
    if($Rechtelijkeambtenaar->save()!==false) die('ok:'.$_SERVER['PHP_SELF'].'?Rechtelijkeambtenaar='.urlencode($Rechtelijkeambtenaar->getId())); else die('Please fix errors!');
  ...
  if(isset($_REQUEST['Rechtelijkeambtenaar'])){
    if(!$del || !delRechtelijkeambtenaar($_REQUEST['Rechtelijkeambtenaar']))
      $Rechtelijkeambtenaar = readRechtelijkeambtenaar($_REQUEST['Rechtelijkeambtenaar']);
    else $Rechtelijkeambtenaar = false; // delete was a succes!
  } else if($new) $Rechtelijkeambtenaar = new Rechtelijkeambtenaar();
  else $Rechtelijkeambtenaar = false;
  if($Rechtelijkeambtenaar){
    writeHead("<TITLE>Rechtelijke ambtenaar - VIRO - ADL Prototype</TITLE>"
              .($edit?'<SCRIPT type="text/javascript" src="edit.js"></SCRIPT>':'<SCRIPT type="text/javascript" src="navigate.js"></SCRIPT>')."\n" );
    if($edit)
        echo '<FORM name="editForm" action="'
              .$_SERVER['PHP_SELF'].'" method="POST" class="Edit">';
    if($edit && $Rechtelijkeambtenaar->isNew())
         echo '<P><INPUT TYPE="TEXT" NAME="ID" VALUE="'.addslashes($Rechtelijkeambtenaar->getId()).'" /></P>';
    else echo '<H1>'.$Rechtelijkeambtenaar->getId().'</H1>';
    ?>
    <DIV class="Floater lid">
      <DIV class="FloaterHeader">lid</DIV>
      <DIV class="FloaterContent"><?php
          $lid = $Rechtelijkeambtenaar->get_lid();
          echo '
          <UL>';
    ...
    <DIV class="Floater rol">
      ...
      <DIV class="FloaterContent"><?php
          $rol = $Rechtelijkeambtenaar->get_rol();
          echo '
          <UL>';
    ...
    <DIV class="Floater geautoriseerd voor">
      ...
      <DIV class="FloaterContent"><?php
          $geautoriseerdvoor = $Rechtelijkeambtenaar->get_geautoriseerdvoor();
          echo '
          <UL>';
    ...
    <DIV class="Floater Zittingen">
      ...
      <DIV class="FloaterContent"><?php
          $Zittingen = $Rechtelijkeambtenaar->get_Zittingen();
          echo '
          <UL>';
            ...
            <LI CLASS="item UI_Zittingen" ID="3.'.$i0.'">';
                ...
                foreach($v0['rechter'] as $i1=>$rechter){
                  ...
                  <LI CLASS="item UI_Zittingen_rechter" ID="3.'.$i0.'.0.'.$i1.'">';
                    ...
                    <A class="GotoLink" id="To3.'.$i0.'.0.'.$i1.'">';
                      ...
                      echo '<LI><A HREF="Rechtelijke ambtenaar.php?Rechtelijkeambtenaar='.urlencode($rechter).'">Rechtelijke ambtenaar</A></LI>';
              ...
              <DIV>';
                ...
                <A class="GotoLink" id="To3.'.$i0.'.1">';
                  ...
                  echo '<LI><A HREF="Rechtelijke ambtenaar.php?Rechtelijkeambtenaar='.urlencode($v0['griffier']).'">Rechtelijke ambtenaar</A></LI>';
    ...
    <DIV class="Floater ontvangen">
      ...
      <DIV class="FloaterContent"><?php
          $ontvangen = $Rechtelijkeambtenaar->get_ontvangen();
          echo '
          <UL>';
            ...
            <LI CLASS="item UI_ontvangen" ID="4.'.$i0.'">';
              ...
              <DIV>';
                ...
                <A class="GotoLink" id="To4.'.$i0.'.1">';
                  ...
                  echo '<LI><A HREF="Rechtelijke ambtenaar.php?Rechtelijkeambtenaar='.urlencode($v0['van']).'">Rechtelijke ambtenaar</A></LI>';
    ...
    <DIV class="Floater verzonden">
      ...
      <DIV class="FloaterContent"><?php
          $verzonden = $Rechtelijkeambtenaar->get_verzonden();
          echo '
          <UL>';
   ...
   if($edit){
     if($new) 
       ...
       $buttons.=ifaceButton("JavaScript:save('".$_SERVER['PHP_SELF']."?save=1','".urlencode($Rechtelijkeambtenaar->getId())."');","Save");
       $buttons.=ifaceButton($_SERVER['PHP_SELF']."?Rechtelijkeambtenaar=".urlencode($Rechtelijkeambtenaar->getId()),"Cancel");
     } 
  } else $buttons.=ifaceButton($_SERVER['PHP_SELF']."?edit=1&Rechtelijkeambtenaar=".urlencode($Rechtelijkeambtenaar->getId()),"Edit")
                 .ifaceButton($_SERVER['PHP_SELF']."?del=1&Rechtelijkeambtenaar=".urlencode($Rechtelijkeambtenaar->getId()),"Delete");
  }else{
    if($del){
      writeHead("<TITLE>Delete geslaagd</TITLE>");
      echo 'The Rechtelijke ambtenaar is deleted';
    }else{  // deze pagina zou onbereikbaar moeten zijn
      writeHead("<TITLE>No Rechtelijke ambtenaar object selected - VIRO - ADL Prototype</TITLE>");
      ?><i>No Rechtelijke ambtenaar object selected</i><?php 
    }
