...
\***************************************/
  ...
  if(isset($_REQUEST['save'])) { // handle ajax save request (do not show the interface)
    ...
    for($i0=0;isset($r['1.'.$i0]);$i0++){
      $Gepland[$i0] = array( 'id' => @$r['1.'.$i0.'.0']
                           , 'rolnr' => @$r['1.'.$i0.'.0']
                           , 'zitting' => @$r['1.'.$i0.'.1']
                           , 'zaak' => @$r['1.'.$i0.'.2']
                           );
    }
    $Rolplanning=new Rolplanning($Rol, $Gepland);
  ...
  $Rolplanning=new Rolplanning();
      ...
      <DIV class="FloaterContent"><?php
          ...
          foreach($Rol as $i0=>$v0){
            ...
            <LI CLASS="item UI_Rol" ID="0.'.$i0.'">';
              ...
              <DIV>';
                echo 'rolnr: ';
                echo '<SPAN CLASS="item UI_Rol_rolnr" ID="0.'.$i0.'.0">';
              ...
              <DIV>';
                ...
                <DIV class ="Holder"><DIV class="HolderHeader">zaak</DIV>
                  <DIV class="HolderContent" name="zaak"><?php
                      echo '<DIV CLASS="UI_Rol_zaak" ID="0.'.$i0.'.1">';
                        if(!$edit){
                          echo '
                        ...
                        <DIV>';
                          echo 'zaaknr: ';
                          echo '<SPAN CLASS="item UI_Rol_zaak_zaaknr" ID="0.'.$i0.'.1.0">';
                        ...
                        <DIV>';
                          ...
                          foreach($v0['zaak']['gedaagde'] as $i1=>$gedaagde){
                            echo '
                            <LI CLASS="item UI_Rol_zaak_gedaagde" ID="0.'.$i0.'.1.1.'.$i1.'">';
                              if(!$edit){
                                echo '
                          ...
                          if($edit) echo '
                            <LI CLASS="new UI_Rol_zaak_gedaagde" ID="0.'.$i0.'.1.1.'.count($v0['zaak']['gedaagde']).'">new gedaagde</LI>';
                          echo '
                          </UL>';
                        echo '</DIV>
                        <DIV>';
                          ...
                          foreach($v0['zaak']['eiser'] as $i1=>$eiser){
                            echo '
                            <LI CLASS="item UI_Rol_zaak_eiser" ID="0.'.$i0.'.1.2.'.$i1.'">';
                              if(!$edit){
                                echo '
                          ...
                          if($edit) echo '
                            <LI CLASS="new UI_Rol_zaak_eiser" ID="0.'.$i0.'.1.2.'.count($v0['zaak']['eiser']).'">new eiser</LI>';
                          echo '
                          </UL>';
                        echo '</DIV>
                        <DIV>';
                          ...
                          foreach($v0['zaak']['gevoegde'] as $i1=>$gevoegde){
                            echo '
                            <LI CLASS="item UI_Rol_zaak_gevoegde" ID="0.'.$i0.'.1.3.'.$i1.'">';
                              if(!$edit){
                                echo '
                          ...
                          if($edit) echo '
                            <LI CLASS="new UI_Rol_zaak_gevoegde" ID="0.'.$i0.'.1.3.'.count($v0['zaak']['gevoegde']).'">new gevoegde</LI>';
                          echo '
                          </UL>';
                        echo '
                        </DIV>';
              ...
              <DIV>';
                ...
                <DIV class ="Holder"><DIV class="HolderHeader">zitting</DIV>
                  <DIV class="HolderContent" name="zitting"><?php
                      echo '<DIV CLASS="UI_Rol_zitting" ID="0.'.$i0.'.2">';
                        if(!$edit){
                          echo '
                        ...
                        <DIV>';
                          echo 'kamer: ';
                          echo '<SPAN CLASS="item UI_Rol_zitting_kamer" ID="0.'.$i0.'.2.0">';
                          if(!$edit) echo '
                        ...
                        <DIV>';
                          ...
                          foreach($v0['zitting']['rechter'] as $i1=>$rechter){
                            echo '
                            <LI CLASS="item UI_Rol_zitting_rechter" ID="0.'.$i0.'.2.1.'.$i1.'">';
                              if(!$edit){
                                echo '
                          ...
                          if($edit) echo '
                            <LI CLASS="new UI_Rol_zitting_rechter" ID="0.'.$i0.'.2.1.'.count($v0['zitting']['rechter']).'">new rechter</LI>';
                          echo '
                          </UL>';
                        echo '</DIV>
                        <DIV>';
                          echo 'griffier: ';
                          echo '<SPAN CLASS="item UI_Rol_zitting_griffier" ID="0.'.$i0.'.2.2">';
                          if(!$edit){
                            echo '
                          <A class="GotoLink" id="To0.'.$i0.'.2.2">';
                            echo htmlspecialchars($v0['zitting']['griffier']).'</A>';
                            echo '<DIV class="Goto" id="GoTo0.'.$i0.'.2.2"><UL>';
                            echo '<LI><A HREF="RechterlijkeAmbtenaar.php?RechterlijkeAmbtenaar='.urlencode($v0['zitting']['griffier']).'">RechterlijkeAmbtenaar</A></LI>';
                        ...
                        <DIV>';
                          echo 'geagendeerd: ';
                          echo '<SPAN CLASS="item UI_Rol_zitting_geagendeerd" ID="0.'.$i0.'.2.3">';
          ...
          if($edit) echo '
            <LI CLASS="new UI_Rol" ID="0.'.count($Rol).'">new Rol</LI>';
          echo '
          </UL>';
        ?> 
      </DIV>
    ...
    <SCRIPT type="text/javascript">
      ...
      function UI_Rol(id){
        return '<DIV>rolnr: <SPAN CLASS="item UI_Rol_rolnr" ID="'+id+'.0"></SPAN></DIV>'
             + '<DIV>zaak: <SPAN CLASS="item UI_Rol_zaak" ID="'+id+'.1"><DIV>zaaknr: <SPAN CLASS="item UI_Rol_zaak_zaaknr" ID="'+id+'.10"></SPAN></DIV><DIV>gedaagde: <UL><LI CLASS="new UI_Rol_zaak_gedaagde" ID="'+id+'.11">new gedaagde</LI></UL></DIV><DIV>eiser: <UL><LI CLASS="new UI_Rol_zaak_eiser" ID="'+id+'.12">new eiser</LI></UL></DIV><DIV>gevoegde: <UL><LI CLASS="new UI_Rol_zaak_gevoegde" ID="'+id+'.13">new gevoegde</LI></UL></DIV></SPAN></DIV>'
             + '<DIV>zitting: <SPAN CLASS="item UI_Rol_zitting" ID="'+id+'.2"><DIV>kamer: <SPAN CLASS="item UI_Rol_zitting_kamer" ID="'+id+'.20"></SPAN></DIV><DIV>rechter: <UL><LI CLASS="new UI_Rol_zitting_rechter" ID="'+id+'.21">new rechter</LI></UL></DIV><DIV>griffier: <SPAN CLASS="item UI_Rol_zitting_griffier" ID="'+id+'.22"></SPAN></DIV><DIV>geagendeerd: <SPAN CLASS="item UI_Rol_zitting_geagendeerd" ID="'+id+'.23"></SPAN></DIV></SPAN></DIV>'
              ;
      }
    </SCRIPT>
    <?php } ?>
    <DIV class="Floater Gepland">
      <DIV class="FloaterHeader">Gepland</DIV>
      <DIV class="FloaterContent"><?php
          $Gepland = $Rolplanning->get_Gepland();
          echo '
          <UL>';
          foreach($Gepland as $i0=>$v0){
            echo '
            <LI CLASS="item UI_Gepland" ID="1.'.$i0.'">';
              if(!$edit){
                echo '
              ...
              <DIV>';
                echo 'rolnr: ';
                echo '<SPAN CLASS="item UI_Gepland_rolnr" ID="1.'.$i0.'.0">';
                echo htmlspecialchars($v0['rolnr']);
                echo '</SPAN>';
              echo '</DIV>
              <DIV>';
                echo 'zitting: ';
                echo '<SPAN CLASS="item UI_Gepland_zitting" ID="1.'.$i0.'.1">';
                if(!$edit) echo '
                <A HREF="Zitting.php?Zitting='.urlencode($v0['zitting']).'">'.htmlspecialchars($v0['zitting']).'</A>';
                else echo htmlspecialchars($v0['zitting']);
                echo '</SPAN>';
              echo '</DIV>
              <DIV>';
                echo 'zaak: ';
                echo '<SPAN CLASS="item UI_Gepland_zaak" ID="1.'.$i0.'.2">';
                if(!$edit){
                  echo '
                <A class="GotoLink" id="To1.'.$i0.'.2">';
                  echo htmlspecialchars($v0['zaak']).'</A>';
                  echo '<DIV class="Goto" id="GoTo1.'.$i0.'.2"><UL>';
                  echo '<LI><A HREF="BasisgegevensUC001.php?BasisgegevensUC001='.urlencode($v0['zaak']).'">BasisgegevensUC001</A></LI>';
                  echo '<LI><A HREF="Procedure.php?Procedure='.urlencode($v0['zaak']).'">Procedure</A></LI>';
                  echo '<LI><A HREF="nieuweProcedure.php?nieuweProcedure='.urlencode($v0['zaak']).'">nieuweProcedure</A></LI>';
                  echo '</UL></DIV>';
                } else echo htmlspecialchars($v0['zaak']);
                echo '</SPAN>';
              echo '
              </DIV>';
              if($edit) echo '
          ...
          if($edit) echo '
            <LI CLASS="new UI_Gepland" ID="1.'.count($Gepland).'">new Gepland</LI>';
          echo '
          </UL>';
        ?> 
      </DIV>
    ...
    <?php if($edit){ ?>
    <SCRIPT type="text/javascript">
      // code for editing blocks in Gepland
      function UI_Gepland(id){
        return '<DIV>rolnr: <SPAN CLASS="item UI_Gepland_rolnr" ID="'+id+'.0"></SPAN></DIV>'
             + '<DIV>zitting: <SPAN CLASS="item UI_Gepland_zitting" ID="'+id+'.1"></SPAN></DIV>'
             + '<DIV>zaak: <SPAN CLASS="item UI_Gepland_zaak" ID="'+id+'.2"></SPAN></DIV>'
              ;
      }
    </SCRIPT>
    <?php } ?>
