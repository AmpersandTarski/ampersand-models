...
\***************************************/
  ...
  require "Rechterlijke_ambtenaar.inc.php";
  ...
  if($Rechterlijkeambtenaar){
    writeHead("<TITLE>Rechterlijke_ambtenaar - VIRO - ADL Prototype</TITLE>"
            ...
            <LI CLASS="item UI_Zittingen" ID="3.'.$i0.'">';
                ...
                foreach($v0['rechter'] as $i1=>$rechter){
                  ...
                  <LI CLASS="item UI_Zittingen_rechter" ID="3.'.$i0.'.0.'.$i1.'">';
                    ...
                    <A class="GotoLink" id="To3.'.$i0.'.0.'.$i1.'">';
                      ...
                      echo '<LI><A HREF="Rechterlijke_ambtenaar.php?Rechterlijkeambtenaar='.urlencode($rechter).'">Rechterlijke_ambtenaar</A></LI>';
              ...
              <DIV>';
                ...
                <A class="GotoLink" id="To3.'.$i0.'.1">';
                  ...
                  echo '<LI><A HREF="Rechterlijke_ambtenaar.php?Rechterlijkeambtenaar='.urlencode($v0['griffier']).'">Rechterlijke_ambtenaar</A></LI>';
            ...
            <LI CLASS="item UI_ontvangen" ID="4.'.$i0.'">';
              ...
              <DIV>';
                ...
                <A class="GotoLink" id="To4.'.$i0.'.1">';
                  ...
                  echo '<LI><A HREF="Rechterlijke_ambtenaar.php?Rechterlijkeambtenaar='.urlencode($v0['van']).'">Rechterlijke_ambtenaar</A></LI>';
   ...
   if($edit){
    ...
    if($del){
      ...
      echo 'The Rechterlijke_ambtenaar is deleted';
    }else{  // deze pagina zou onbereikbaar moeten zijn
      writeHead("<TITLE>No Rechterlijke_ambtenaar object selected - VIRO - ADL Prototype</TITLE>");
      ?><i>No Rechterlijke_ambtenaar object selected</i><?php 
    }
