<?php // generated with ADL vs. 0.8.10-451
  ...
  /********* on line 3839, file "VIRO.adl"
    SERVICE Rechterlijke_ambtenaar : I[Persoon]
   = [ lid : bezetting
        = [ kamer : [Kamer]
          , gerecht : gerecht
          , sectorSector : sector
  ...
  class Rechterlijke_ambtenaar {
    ...
    private $_ontvangen;
    private $_verzonden;
    function Rechterlijke_ambtenaar($id=null, $lid=null, $rol=null, $geautoriseerdvoor=null, $Zittingen=null, $ontvangen=null, $verzonden=null){
      $this->_id=$id;
      $this->_lid=$lid;
      $this->_rol=$rol;
      ...
      if(!isset($lid) && isset($id)){
        // get a Rechterlijke_ambtenaar based on its identifier
        // check if it exists:
