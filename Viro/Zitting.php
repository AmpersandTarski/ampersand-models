    ...
    <DIV class="Floater griffier">
      ...
      <DIV class="FloaterContent"><?php
          ...
          <A class="GotoLink" id="To4">';
            ...
            echo '<LI><A HREF="RechterlijkeAmbtenaar.php?RechterlijkeAmbtenaar='.urlencode($griffier).'">RechterlijkeAmbtenaar</A></LI>';
    ...
    <DIV class="Floater feitelijkedatum">
      ...
      <DIV class="FloaterContent"><?php
          ...
          if (isset($feitelijkedatum)){
            echo '<DIV CLASS="item UI_feitelijkedatum" ID="6">';
            echo '</DIV>';
            if(isset($feitelijkedatum)){
              echo htmlspecialchars($feitelijkedatum);
            }
          } else echo '<DIV CLASS="new UI_feitelijkedatum" ID="6"><I>Nothing</I></DIV>';
        ?> 
      </DIV>
    </DIV>
