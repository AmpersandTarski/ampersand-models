<?php // generated with ADL vs. 0.8.10-451
  ...
  /********* on line 3825, file "VIRO.adl"
    SERVICE Rechtelijke ambtenaar : I[Persoon]
   = [ lid : bezetting
        = [ kamer : [Kamer]
          , gerecht : gerecht
          , sectorSector : sector
  ...
  class Rechtelijke ambtenaar {
    ...
    private $_ontvangen;
    private $_verzonden;
    function Rechtelijke ambtenaar($id=null, $lid=null, $rol=null, $geautoriseerdvoor=null, $Zittingen=null, $ontvangen=null, $verzonden=null){
      $this->_id=$id;
      $this->_lid=$lid;
      $this->_rol=$rol;
      ...
      if(!isset($lid) && isset($id)){
        // get a Rechtelijke ambtenaar based on its identifier
        // check if it exists:
  ...
  function getEachRechtelijkeambtenaar(){
    return firstCol(DB_doquer('SELECT DISTINCT `i`
                                 FROM `persoon`'));
  }

  function readRechtelijkeambtenaar($id){
      // check existence of $id
      $obj = new Rechtelijkeambtenaar($id);
      if($obj->isNew()) return false; else return $obj;
  }

  function delRechtelijkeambtenaar($id){
    $tobeDeleted = new Rechtelijkeambtenaar($id);
