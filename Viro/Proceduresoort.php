  ...
  if(isset($_REQUEST['save'])) { // handle ajax save request (do not show the interface)
    ...
    for($i0=0;isset($r['0.'.$i0]);$i0++){
      $Procedures[$i0] = array( 'id' => @$r['0.'.$i0.'.0']
                              ...
                              , 'zorgdrager voor dossier' => @$r['0.'.$i0.'.2']
                              );
    }
          ...
          foreach($Procedures as $i0=>$v0){
            ...
            <LI CLASS="item UI" ID="0.'.$i0.'">';
              ...
              <DIV>';
                ...
                echo '<SPAN CLASS="item UIzorgdragervoordossier" ID="0.'.$i0.'.2">';
                if(!$edit) echo '
    ...
    <SCRIPT type="text/javascript">
      ...
      function UI(id){
        return '<DIV>Procedure: <SPAN CLASS="item UI_Procedure" ID="'+id+'.0"></SPAN></DIV>'
             ...
             + '<DIV>zorgdrager voor dossier: <SPAN CLASS="item UI_zorgdragervoordossier" ID="'+id+'.2"></SPAN></DIV>'
              ;
      }
    </SCRIPT>
    <?php } ?>
