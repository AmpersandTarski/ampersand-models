<?php // generated with ADL vs. 0.8.10-451
  ...
  class Gerechtelijkeambtenaar {
    ...
    function Gerechtelijkeambtenaar($id=null, $lid=null, $rol=null, $geautoriseerdvoor=null, $Zittingen=null, $ontvangen=null, $verzonden=null){
      ...
      if(!isset($lid) && isset($id)){
        // get a Gerechtelijkeambtenaar based on its identifier
        // check if it exists:
  ...
  function getEachGerechtelijkeambtenaar(){
    return firstCol(DB_doquer('SELECT DISTINCT `i`
                                 FROM `persoon`'));
  }

  function readGerechtelijkeambtenaar($id){
      // check existence of $id
      $obj = new Gerechtelijkeambtenaar($id);
      if($obj->isNew()) return false; else return $obj;
  }

  function delGerechtelijkeambtenaar($id){
    $tobeDeleted = new Gerechtelijkeambtenaar($id);
