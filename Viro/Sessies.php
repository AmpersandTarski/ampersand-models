      ...
      <DIV class="FloaterContent"><?php
          ...
          foreach($Sessies as $i0=>$v0){
            ...
            <LI CLASS="item UI" ID="0.'.$i0.'">';
              ...
              <DIV>';
                echo 'einde: ';
                echo '<SPAN CLASS="item UIeinde" ID="0.'.$i0.'.2">';
                if(isset($v0['einde'])){
              ...
              <DIV>';
                ...
                if(!$edit) echo '
                <A HREF="Rol.php?Rol='.urlencode($v0['rol']).'">'.htmlspecialchars($v0['rol']).'</A>';
                else echo htmlspecialchars($v0['rol']);
                echo '</SPAN>';
              echo '</DIV>
              <DIV>';
                echo 'persoon: ';
                ...
                <A class="GotoLink" id="To0.'.$i0.'.5">';
                  ...
                  echo '<LI><A HREF="Gerechtelijkeambtenaar.php?Gerechtelijkeambtenaar='.urlencode($v0['persoon']).'">Gerechtelijkeambtenaar</A></LI>';
