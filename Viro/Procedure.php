  ...
  if(isset($_REQUEST['save'])) { // handle ajax save request (do not show the interface)
    ...
    for($i0=0;isset($r['15.'.$i0]);$i0++){
      $zittingen[$i0] = array( 'id' => @$r['15.'.$i0.'']
                             , 'behandeling' => array( 'id' => @$r['15.'.$i0.'.0.0'], 'zitting' => @$r['15.'.$i0.'.0.0'], 'locatieGerecht' => @$r['15.'.$i0.'.0.2'], 'kamerKamer' => @$r['15.'.$i0.'.0.3'])
                             );
    }
  ...
  if($Procedure){
                  ...
                  <DIV class="HolderContent" name="behandeling"><?php
                      echo '<DIV CLASS="UI_zittingen" ID="15.'.$i0.'.0">';
                        ...
                        <DIV>';
                          ...
                          echo '
                          <UL>';
                          foreach($v0['behandeling']['rechterPersoon'] as $i1=>$rechterPersoon){
                            echo '
                            <LI CLASS="item UI_zittingen_rechterPersoon" ID="15.'.$i0.'.0.1.'.$i1.'">';
                              if(!$edit){
                                echo '
                          ...
                          if($edit) echo '
                            <LI CLASS="new UI_zittingen_rechterPersoon" ID="15.'.$i0.'.0.1.'.count($v0['behandeling']['rechterPersoon']).'">new rechterPersoon</LI>';
                          echo '
                          </UL>';
                        echo '</DIV>
                        <DIV>';
                          echo 'locatieGerecht: ';
                          echo '<SPAN CLASS="item UI_zittingen_locatieGerecht" ID="15.'.$i0.'.0.2">';
                          if(!$edit) echo '
                          <A HREF="Gerecht.php?Gerecht='.urlencode($v0['behandeling']['locatieGerecht']).'">'.htmlspecialchars($v0['behandeling']['locatieGerecht']).'</A>';
                          else echo htmlspecialchars($v0['behandeling']['locatieGerecht']);
                          echo '</SPAN>';
                        echo '</DIV>
                        <DIV>';
                          echo 'kamerKamer: ';
                          echo '<SPAN CLASS="item UI_zittingen_kamerKamer" ID="15.'.$i0.'.0.3">';
                          if(!$edit) echo '
                          <A HREF="Kamer.php?Kamer='.urlencode($v0['behandeling']['kamerKamer']).'">'.htmlspecialchars($v0['behandeling']['kamerKamer']).'</A>';
                          else echo htmlspecialchars($v0['behandeling']['kamerKamer']);
                          echo '</SPAN>';
                        echo '
                        </DIV>';
                        if($edit) echo '
    ...
    <SCRIPT type="text/javascript">
      ...
      function UI_zittingen(id){
        return '<DIV>behandeling: <SPAN CLASS="item UI_zittingen_behandeling" ID="'+id+'.0"><DIV>zitting: <SPAN CLASS="item UI_zittingen_behandeling_zitting" ID="'+id+'.00"></SPAN></DIV><DIV>rechterPersoon: <UL><LI CLASS="new UI_zittingen_behandeling_rechterPersoon" ID="'+id+'.01">new rechterPersoon</LI></UL></DIV><DIV>locatieGerecht: <SPAN CLASS="item UI_zittingen_behandeling_locatieGerecht" ID="'+id+'.02"></SPAN></DIV><DIV>kamerKamer: <SPAN CLASS="item UI_zittingen_behandeling_kamerKamer" ID="'+id+'.03"></SPAN></DIV></SPAN></DIV>'
              ;
      }
    </SCRIPT>
    <?php } ?>
