...
RULE "opvolgend versienummer" MAINTAINS pre~;post /\ object;object~ /\ -I |- versie;isOpvolgerVan~;versie~
...
RULE "isOpvolgerVan irreflexief" MAINTAINS isOpvolgerVan |- -I
RULE "ouder dan" MAINTAINS (I \/ lt);isOpvolgerVan~ |- lt
...
isVoorgangerVan |- -I EXPLANATION "de relatie 'isVoorgangerVan' is irreflexief."

RULE "voorganger" MAINTAINS isVoorgangerVan = post~;pre /\ versie;isOpvolgerVan;versie~ /\ object;object~
EXPLANATION "Inhoud X is de voorganger van inhoud Y als er een gebeurtenis is waarin X werd getransformeerd in Y en vice versa."
...
{+Om te kunnen natrekken hoe de inhoud van een object tot stand is gekomen moet een ononderbroken ketting van inhouden kunnen worden geconstrueerd, voor zover de geschiedenis is opgeslagen.-}
isOpvolgerVan |- -I EXPLANATION "de relatie 'isOpvolgerVan' is irreflexief."

RULE "directe opvolgers" MAINTAINS isDirecteOpvolgerVan = pre~;post /\ versie;isOpvolgerVan~;versie~ /\ object;object~
EXPLANATION "Inhoud Y is een opvolger van inhoud X als er een gebeurtenis is waarin X werd getransformeerd in Y en vice versa."
...
RULE "alle opvolgers" MAINTAINS isDirecteOpvolgerVan;(I \/ isIndirecteOpvolgerVan) |- isIndirecteOpvolgerVan
EXPLANATION "Inhoud Y is een indirecte opvolger van inhoud X als er een of meer gebeurtenissen zijn waarin X werd getransformeerd in Y en vice versa."
...
RULE "database schoon houden" MAINTAINS object;inhoud |- I \/ isIndirecteOpvolgerVan~ 
