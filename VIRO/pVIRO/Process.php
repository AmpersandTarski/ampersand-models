      ...
      <DIV class="FloaterContent"><?php
          ...
          echo '<DIV CLASS="UI_case" ID="1">';
            ...
            <DIV>';
              ...
              echo '
              <UL>';
              foreach($case['type of case'] as $i0=>$typeofcase){
                echo '
                <LI CLASS="item UI_case_typeofcase" ID="1.1.'.$i0.'">';
                  if(!$edit) echo '
              ...
              if($edit) echo '
                <LI CLASS="new UI_case_typeofcase" ID="1.1.'.count($case['type of case']).'">new type of case</LI>';
              echo '
              </UL>';
            echo '</DIV>
            <DIV>';
