...
\***************************************/
  ...
  if(isset($_REQUEST['save'])) { // handle ajax save request (do not show the interface)
    ...
    for($i0=0;isset($r['0.'.$i0]);$i0++){
      ...
      $Authorizations[$i0]['by']=array();
      for($i1=0;isset($r['0.'.$i0.'.2.'.$i1]);$i1++){
        $Authorizations[$i0]['by'][$i1] = @$r['0.'.$i0.'.2.'.$i1.''];
      }
          ...
          foreach($Authorizations as $i0=>$v0){
            ...
            <LI CLASS="item UI" ID="0.'.$i0.'">';
              ...
              <DIV>';
                ...
                echo '
                <UL>';
                foreach($v0['by'] as $i1=>$by){
                  echo '
                  <LI CLASS="item UIby" ID="0.'.$i0.'.2.'.$i1.'">';
                    if(!$edit){
                      echo '
                ...
                if($edit) echo '
                  <LI CLASS="new UIby" ID="0.'.$i0.'.2.'.count($v0['by']).'">new by</LI>';
                echo '
                </UL>';
              echo '</DIV>
              <DIV>';
    ...
    <SCRIPT type="text/javascript">
      ...
      function UI(id){
        return '<DIV>document: <SPAN CLASS="item UI_document" ID="'+id+'.0"></SPAN></DIV>'
             ...
             + '<DIV>by: <UL><LI CLASS="new UI_by" ID="'+id+'.2">new by</LI></UL></DIV>'
