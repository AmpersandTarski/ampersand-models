...
\***************************************/
  ...
  if(isset($_REQUEST['save'])) { // handle ajax save request (do not show the interface)
    ...
    for($i0=0;isset($r['0.'.$i0]);$i0++){
      ...
      $Interestedparties[$i0]['role']=array();
      for($i1=0;isset($r['0.'.$i0.'.1.'.$i1]);$i1++){
        $Interestedparties[$i0]['role'][$i1] = @$r['0.'.$i0.'.1.'.$i1.''];
      }
            ...
            <LI CLASS="item UI" ID="0.'.$i0.'">';
              ...
              <DIV>';
                ...
                foreach($v0['role'] as $i1=>$role){
                  echo '
                  <LI CLASS="item UIrole" ID="0.'.$i0.'.1.'.$i1.'">';
                    echo htmlspecialchars($role);
                  echo '</LI>';
                }
                if($edit) echo '
                  <LI CLASS="new UIrole" ID="0.'.$i0.'.1.'.count($v0['role']).'">new role</LI>';
                echo '
                </UL>';
              echo '</DIV>
              <DIV>';
    ...
    <SCRIPT type="text/javascript">
      ...
      function UI(id){
        return '<DIV>name: <SPAN CLASS="item UI_name" ID="'+id+'.0"></SPAN></DIV>'
             + '<DIV>role: <UL><LI CLASS="new UI_role" ID="'+id+'.1">new role</LI></UL></DIV>'
