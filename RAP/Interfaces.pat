...
PATTERN Interfaces --!EXTENDS Relations
 aut      :: FactType * Interface PRAGMA "declaration " " is computed automatically in interface ".
 to       :: Trigger * FactType   PRAGMA "trigger " " changes declaration ".
 from     :: Trigger * FactType   PRAGMA "trigger " " uses declaration ".
 ...
 to       :: Interface * FactType PRAGMA "interface " " changes declaration ".
 from     :: Interface * FactType PRAGMA "interface " " uses declaration ".
