...
intensionAuthority :: BusinessRule -> Holon PRAGMA "The authority for the intension (meaning) associated with " " is (the manager of) " -- this relation used to be called 'ruleScope'
PURPOSE RELATION intensionAuthority[BusinessRule*Holon] IN ENGLISH
...
PURPOSE RELATION intensionAuthority[BusinessRule*Holon] IN DUTCH
...
RULE "ruleKey": I[BusinessRule] = ruleText;ruleText~ /\ intensionAuthority[BusinessRule*Holon]; intensionAuthority[BusinessRule*Holon]~
...
RULE "formal rule uniqueness": formalExpr; formalExpr~ |- I \/ intensionAuthority[BusinessRule*Holon]; -I; intensionAuthority[BusinessRule*Holon]~
