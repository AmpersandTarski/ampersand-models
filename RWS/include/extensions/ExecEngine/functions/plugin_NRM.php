...
{  if ($tgtAtom === "") $tgtAtom=0;
   if ($tgtAtom < 1) echo "ExecEngineSHOUTS(Decrement below zero: $relation, $srcConcept, $srcAtom, $tgtConcept, $tgtAtom)";
   $tgtAtom = $tgtAtom - 1;
   InsPair($relation,$srcConcept,$srcAtom,$tgtConcept,$tgtAtom);
   return;
}
...
{  if ($noemer == 0) echo "ExecEngineSHOUTS(Cannot divide by zero: $teller, $noemer)";
