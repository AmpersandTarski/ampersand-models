<?php
  ...
  // Generated with ADL vs. 0.8.10-493
  ...
  * use the $extraheaders argument to pass extra headers         *
  ...
  function writeTail($buttons=""){
    ...
    <div class="cNotice"><center><a title="&copy; Sebastiaan JC Joosten 2005-2009, generated with ADL vs. 0.8.10-493">Layout V1.4 alpha</A></center></div>
    </BODY></HTML><?php
  }
