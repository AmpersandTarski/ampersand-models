<?php // generated with ADL vs. 0.8.10-529
  ...
  /********* on line 159, file "comp/PWO_gmi/20.adl"
  ...
  class Pattern {
    ...
    function Pattern($id=null, $_rules=null, $_relations=null, $_isarelations=null){
      $this->id=$id;
      $this->_rules=$_rules;
    ...
    function save(){
      ...
      * All attributes are saved *
      ...
      $me=array("id"=>$this->getId(), "rules" => $this->_rules, "relations" => $this->_relations, "isa_relations" => $this->_isarelations);
